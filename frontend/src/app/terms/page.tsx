  ...
  return (
    ...
    >
      <LegalSection title="1. The service">
        <p>
          JobLens is an AI-assisted toolkit for job seekers: resume analysis, job matching, application tracking, and
      ...
      <LegalSection title="2. AI-generated content">
        <p>
          Scores, suggestions, interview questions, and cover letters are generated by an AI model and are <strong>advisory
          only</strong>. They may contain inaccuracies. You're responsible for reviewing and editing any AI-generated
      ...
      <LegalSection title="3. Your responsibilities">
        <ul>
          ...
          <li>Don't attempt to abuse, overload, or reverse-engineer the service or its AI integrations.</li>
      ...
      <LegalSection title="6. Limitation of liability">
        <p>
          ...
          your use of the service, including decisions made based on AI-generated scores or suggestions, to the fullest
